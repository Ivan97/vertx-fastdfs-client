...
public interface FdfsClient {
   ...
   * @return the client
   */
  FdfsClient upload(ReadStream<Buffer> stream, long size, String ext,
   ...
   * @return the client
   */
  FdfsClient uploadAppender(ReadStream<Buffer> stream, long size, String ext,
      Handler<AsyncResult<FdfsFileId>> handler);
   ...
   * @return the client
   */
  FdfsClient uploadAppender(String fileFullPathName, String ext,
      Handler<AsyncResult<FdfsFileId>> handler);
   ...
   * @return the client
   */
  FdfsClient append(ReadStream<Buffer> stream, long size, FdfsFileId fileId,
   ...
   * @return the client
   */
  FdfsClient modify(ReadStream<Buffer> stream, long size, FdfsFileId fileId, long offset,
      Handler<AsyncResult<Void>> handler);
   ...
   * @return the client
   */
  FdfsClient modify(String fileFullPathName, FdfsFileId fileId, long offset,
      Handler<AsyncResult<Void>> handler);
   ...
   * @return the client
   */
  FdfsClient modify(Buffer buffer, FdfsFileId fileId, long offset,
      Handler<AsyncResult<Void>> handler);
   ...
   * @return the client
   */
  FdfsClient download(FdfsFileId fileId, WriteStream<Buffer> stream, long offset, long bytes,
      Handler<AsyncResult<Void>> handler);
   ...
   * @return the client
   */
  FdfsClient download(FdfsFileId fileId, String fileFullPathName, long offset, long bytes,
      Handler<AsyncResult<Void>> handler);
   ...
   * @return the client
   */
  FdfsClient download(FdfsFileId fileId, long offset, long bytes,
   ...
   * @return the client
   */
  FdfsClient setMetaData(FdfsFileId fileId, JsonObject metaData, byte flag,
      Handler<AsyncResult<Void>> handler);
