...
public interface FdfsStorage {
   ...
   * @return the storage
   */
  FdfsStorage upload(ReadStream<Buffer> stream, long size, String ext,
   ...
   * @return the storage
   */
  FdfsStorage uploadAppender(ReadStream<Buffer> stream, long size, String ext,
      Handler<AsyncResult<FdfsFileId>> handler);
   ...
   * @return the storage
   */
  FdfsStorage uploadAppender(String fileFullPathName, String ext,
      Handler<AsyncResult<FdfsFileId>> handler);
   ...
   * @return the storage
   */
  FdfsStorage append(ReadStream<Buffer> stream, long size, FdfsFileId fileId,
   ...
   * @return the storage
   */
  FdfsStorage append(String fileFullPathName, FdfsFileId fileId,
      Handler<AsyncResult<Void>> handler);
   ...
   * @return the storage
   */
  FdfsStorage modify(ReadStream<Buffer> stream, long size, FdfsFileId fileId, long offset,
      Handler<AsyncResult<Void>> handler);
   ...
   * @return the storage
   */
  FdfsStorage modify(String fileFullPathName, FdfsFileId fileId, long offset,
      Handler<AsyncResult<Void>> handler);
   ...
   * @return the storage
   */
  FdfsStorage modify(Buffer buffer, FdfsFileId fileId, long offset,
      Handler<AsyncResult<Void>> handler);
   ...
   * @return the storage
   */
  FdfsStorage download(FdfsFileId fileId, WriteStream<Buffer> stream, long offset, long bytes,
      Handler<AsyncResult<Void>> handler);
   ...
   * @return the storage
   */
  FdfsStorage download(FdfsFileId fileId, String fileFullPathName, long offset, long bytes,
      Handler<AsyncResult<Void>> handler);
   ...
   * @return the storage
   */
  FdfsStorage download(FdfsFileId fileId, long offset, long bytes,
   ...
   * @return the storage
   */
  FdfsStorage setMetaData(FdfsFileId fileId, JsonObject metaData, byte flag,
      Handler<AsyncResult<Void>> handler);
   ...
   * @return the storage
   */
  FdfsStorage setMetaData(FdfsFileId fileId, JsonObject metaData,
      Handler<AsyncResult<Void>> handler);
